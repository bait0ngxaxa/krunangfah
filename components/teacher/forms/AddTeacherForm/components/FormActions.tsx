    ...
    return (
        <div className="flex gap-4 pt-4 border-t border-emerald-100">
            ...
            <button
                type="button"
                onClick={onCancel}
                className="px-6 py-3 border border-emerald-200 text-gray-600 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-300 transition-base font-medium"
            >
                ยกเลิก
            </button>
        </div>
