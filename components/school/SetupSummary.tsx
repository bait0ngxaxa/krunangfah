...
export function SetupSummary({
    ...
    return (
        <div className="space-y-5">
            ...
            {/* School info */}
            <div className="flex items-start gap-3 p-4 bg-white rounded-2xl border-2 border-gray-100 shadow-sm transition-base hover:shadow-md hover:border-[var(--brand-primary)]/50">
