            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-2.5 border border-emerald-200 rounded-xl focus:ring-4 focus:ring-emerald-100 focus:border-emerald-400 outline-none bg-white transition-base hover:border-emerald-300 text-slate-900 truncate"
                    >
