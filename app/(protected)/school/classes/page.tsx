...
export default async function SchoolClassesPage() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-50 py-6 px-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 translate-x-1/2 translate-y-1/2 pointer-events-none" />
            ...
            <div className="max-w-2xl mx-auto relative z-10">
                ...
                {/* Section: Classes */}
                <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-xl shadow-emerald-100/50 p-6 sm:p-8 border border-emerald-100 mb-6">
