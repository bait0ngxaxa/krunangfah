    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-50 py-6 px-4 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="relative bg-white/90 backdrop-blur-md rounded-3xl shadow-xl shadow-emerald-100/50 p-6 md:p-8 border border-emerald-200 ring-1 ring-emerald-50 overflow-hidden animate-fade-in-up">
                    {/* Corner decoration */}
                    ...
                    {/* Guidelines Content */}
                    <div className="bg-white/60 rounded-2xl p-8 mb-8 border border-emerald-50/50 shadow-sm">
                        ...
                        <ul className="space-y-4 text-gray-700">
                            <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/50 transition-colors border border-transparent hover:border-emerald-100">
                                <Handshake className="w-6 h-6 text-emerald-500 shrink-0 mt-0.5" />
                                <span className="font-medium text-lg">
                                    สร้างความสัมพันธ์ที่ดีและความไว้วางใจกับนักเรียน
                                </span>
                            </li>
                            <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/50 transition-colors border border-transparent hover:border-emerald-100">
                                <Ear className="w-6 h-6 text-emerald-500 shrink-0 mt-0.5" />
                                <span className="font-medium text-lg">
                            ...
                            <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/50 transition-colors border border-transparent hover:border-emerald-100">
                                <Lightbulb className="w-6 h-6 text-emerald-500 shrink-0 mt-0.5" />
                                <span className="font-medium text-lg">
                            ...
                            <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/50 transition-colors border border-transparent hover:border-emerald-100">
                                <Hospital className="w-6 h-6 text-emerald-500 shrink-0 mt-0.5" />
                                <span className="font-medium text-lg">
